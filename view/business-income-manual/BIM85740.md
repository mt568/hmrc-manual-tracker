---
base_path: /hmrc-internal-manuals/business-income-manual/bim85740
public_updated_at: '2018-10-03T16:15:14+01:00'
section_id: BIM85740
title: 'Trade losses - restriction of relief: contrived trading losses'
---
...
1. A business which is distinct from the trader’s usual activities is commenced shortly before the start of a tax year (or, in the case of a company, an accounting period), and accounts for the new business disclose a substantial loss in excess of the capital contributed.
2. In the case of a company, the loss is roughly equivalent to the profits of the accounting period from the company’s other trading activities, or is surrendered as group relief.
3. The asset or assets used in the business may be situated in, or acquired from, a place outside the UK.
4. There are substantial borrowings which may be from the vendor of the asset, a person connected with him, or a foreign based bank which later assigns its loan to one of these.
5. There is evidence of non-recourse finance.
6. There is evidence of expenditure matched by allegedly non-taxable receipts.
7. There is evidence of the manipulation of timing differences.
